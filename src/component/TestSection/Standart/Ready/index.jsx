...
const TalentRegister = () => {
	...
	${value === 3 ? 'bg-[#F4F7FE] border-[blue] border-opacity-50' : ''}
			...
			>
				...
				<p className="w-[638px] text-[#18181B]   text-[24px] font-[600] mb-[8px] max-[1400px]:w-[100%] max-[700px]:text-center">
					Soha
				</p>
				<p className="text-gray-700 text-[14px] mb-[20px] font-[500] mt-[20px] mb-[8px] max-[1400px]:w-[100%] max-[700px]:text-center">
